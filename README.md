...
```javascript
import isNaNArray from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-nan-array@v0.2.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/assert-is-nan-array/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/assert-is-nan-array/actions/workflows/test.yml?query=branch:v0.2.1
